	...
	tests := []struct {
	...
	}{
		{
			...
			wantStrings: []string{
				...
				"Documentation: https://github.github.io/gh-aw/reference/engines/#anthropic-claude-code",
				"<details>",
	...
	tests := []struct {
	...
	}{
		{
			...
			wantStrings: []string{
				...
				"run: /opt/gh-aw/actions/validate_multi_secret.sh CODEX_API_KEY OPENAI_API_KEY Codex https://github.github.io/gh-aw/reference/engines/#openai-codex",
		...
		},
		{
			...
			wantStrings: []string{
				...
				"run: /opt/gh-aw/actions/validate_multi_secret.sh COPILOT_GITHUB_TOKEN 'GitHub Copilot CLI' https://github.github.io/gh-aw/reference/engines/#github-copilot-default",
		...
		},
		{
			...
			wantStrings: []string{
				...
				"run: /opt/gh-aw/actions/validate_multi_secret.sh CLAUDE_CODE_OAUTH_TOKEN ANTHROPIC_API_KEY 'Claude Code' https://github.github.io/gh-aw/reference/engines/#anthropic-claude-code",
